...
exports.resumeType = exports.referencesType = exports.interestsType = exports.languagesType = exports.skillsType = exports.publicationsType = exports.awardsType = exports.educationType = exports.volunteerType = exports.workType = exports.basicsType = exports.profileType = exports.locationType = exports.raz = void 0;
    ...
    work: [
        {
            ...
            position: "Principal, Software Engineering (prev: Solution Architect in SE)",
...
`,
    ...
    volunteer: [
        ...
        },
        {
            ...
            summary: "Sorting and packing food donations for distribution to local food pantries.",
        },
    ],
    education: [
        {
...
exports.locationType = prop_types_1.default.shape({
    address: prop_types_1.default.string,
    postalCode: prop_types_1.default.string,
    city: prop_types_1.default.string,
    countryCode: prop_types_1.default.string,
    region: prop_types_1.default.string,
}).isRequired;
exports.profileType = prop_types_1.default.shape({
    network: prop_types_1.default.string,
    username: prop_types_1.default.string,
    url: prop_types_1.default.string,
}).isRequired;
exports.basicsType = prop_types_1.default.shape({
    name: prop_types_1.default.string,
    label: prop_types_1.default.string,
    picture: prop_types_1.default.string,
    email: prop_types_1.default.string,
    phone: prop_types_1.default.string,
    website: prop_types_1.default.string,
    summary: prop_types_1.default.string,
    location: prop_types_1.default.shape(exports.locationType),
    profiles: prop_types_1.default.arrayOf(exports.profileType),
}).isRequired;
exports.workType = prop_types_1.default.arrayOf(prop_types_1.default.shape({
    company: prop_types_1.default.string,
    position: prop_types_1.default.string,
    website: prop_types_1.default.string,
    startDate: prop_types_1.default.string,
    endDate: prop_types_1.default.string,
    summary: prop_types_1.default.string,
    highlights: prop_types_1.default.arrayOf(prop_types_1.default.string),
})).isRequired;
exports.volunteerType = prop_types_1.default.arrayOf(prop_types_1.default.shape({
    organization: prop_types_1.default.string,
    position: prop_types_1.default.string,
    website: prop_types_1.default.string,
    startDate: prop_types_1.default.string,
    endDate: prop_types_1.default.string,
...
exports.educationType = prop_types_1.default.arrayOf(prop_types_1.default.shape({
    institution: prop_types_1.default.string,
    area: prop_types_1.default.string,
    studyType: prop_types_1.default.string,
    startDate: prop_types_1.default.string,
    endDate: prop_types_1.default.string,
    gpa: prop_types_1.default.string,
    courses: prop_types_1.default.arrayOf(prop_types_1.default.string),
})).isRequired;
exports.awardsType = prop_types_1.default.arrayOf(prop_types_1.default.shape({
    title: prop_types_1.default.string,
    date: prop_types_1.default.string,
    awarder: prop_types_1.default.string,
    summary: prop_types_1.default.string,
})).isRequired;
exports.publicationsType = prop_types_1.default.arrayOf(prop_types_1.default.shape({
    name: prop_types_1.default.string,
    publisher: prop_types_1.default.string,
    releaseDate: prop_types_1.default.string,
    website: prop_types_1.default.string,
    summary: prop_types_1.default.string,
})).isRequired;
exports.skillsType = prop_types_1.default.arrayOf(prop_types_1.default.shape({
    name: prop_types_1.default.string,
    level: prop_types_1.default.number,
    keywords: prop_types_1.default.arrayOf(prop_types_1.default.string),
})).isRequired;
exports.languagesType = prop_types_1.default.arrayOf(prop_types_1.default.shape({
    name: prop_types_1.default.string,
    level: prop_types_1.default.string,
})).isRequired;
exports.interestsType = prop_types_1.default.arrayOf(prop_types_1.default.shape({
    name: prop_types_1.default.string,
    keywords: prop_types_1.default.arrayOf(prop_types_1.default.string),
})).isRequired;
exports.referencesType = prop_types_1.default.arrayOf(prop_types_1.default.shape({
    name: prop_types_1.default.string,
    reference: prop_types_1.default.string,
})).isRequired;
exports.resumeType = prop_types_1.default.shape({
    basics: exports.basicsType,
    work: exports.workType,
    volunteer: exports.volunteerType,
    education: exports.educationType,
    awards: exports.awardsType,
    publications: exports.publicationsType,
    skills: exports.skillsType,
    languages: exports.languagesType,
    interests: exports.interestsType,
    references: exports.referencesType,
});
