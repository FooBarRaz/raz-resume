...
export const raz = {
  ...
  work: [
    ...
    {
      company: "Statewide Judicial Technology Organization",
      position: "Principal Engineer / Architect",
      startDate: "2025-04-01",
      endDate: "Present",
      summary: `Principal engineer and architect on the central case-management pod for a statewide judicial digital transformation initiative. Led design, development, and delivery of the core case management product, replacing fragmented legacy court systems with a unified, cloud-native platform for multiple court types and judicial workflows. Served as a principal driver of AI enablement and acceleration, helping the team adopt and evolve AI tooling, engineering practices, and delivery workflows across the project.`,
      highlights: [
        "Led architecture and delivery for the pivotal case-management pod at the center of a multi-pod modernization program",
        "Designed core platform capabilities for end-to-end case lifecycle management across diverse court workflows",
        "Delivered product patterns supporting standardized yet configurable processes for local court variation",
        "Built foundational workflows for cross-court navigation, e-filing, document management, document validation, calendars, and dockets",
        "Partnered with product, design, engineering, and public-sector stakeholders through discovery, MVP delivery, and court onboarding",
        "Helped translate 120+ features and 850+ user stories into executable architecture and delivery plans",
        "Advanced AI-assisted delivery practices across the team, including tooling adoption, workflow design, and engineering enablement",
        "Supported MVP delivery, training, configuration, data migration, and rollout activities for onboarding multiple courts",
    ...
    {
      company: "Aviation Weather Technology Provider",
      position: "Principal Engineer / Architect",
      startDate: "2024-04-01",
      endDate: "2025-03-31",
      summary: `Principal engineer and architect for a one-year modernization of a legacy desktop flight dispatch application into a modern web platform for airline dispatchers. Partnered with an integrated consulting and client engineering/design team through discovery, architecture, product framing, and delivery. Helped define the technical foundation and interaction patterns for a regulated aviation workflow that consolidates weather, flight, route, and alerting data so dispatchers can monitor aircraft from gate departure through arrival.`,
      highlights: [
        "Led architecture and hands-on engineering for a mission-critical aviation dispatch product modernization",
        "Framed the product and technical backlog during a 6-week discovery phase, then delivered through a 52-week build",
        "Designed web application patterns to replace a Windows-dependent thick client with a browser-based dispatch experience",
        "Consolidated disparate weather, route, aircraft, and alerting data into dispatcher-focused workflows",
        "Reduced alert fatigue through clearer prioritization, information architecture, and interaction design",
        "Supported 14 CFR Part 121 flight dispatch monitoring and operational compliance workflows",
        "Helped take the product from pilot feedback in late 2024 to production go-live for two airline customers by March 2025",
        "Contributed foundational architecture and delivery patterns for future aviation products across the client organization",
